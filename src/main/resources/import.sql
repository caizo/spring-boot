...
INSERT INTO tbl_products (id,name, description, stock,price,status, create_at,category_id)VALUES (2,'under armour Mens Micro G Assert – 7','under armour Men Lightweight mesh upper delivers complete breathability . Durable leather overlays for stability ',4,12.5,'CREATED','2018-09-05',1);
...
INSERT INTO tbl_accounts(id,holder,balance) VALUES(1,'Juan',1000);
INSERT INTO tbl_accounts(id,holder,balance) VALUES(2,'Jose',2000);
INSERT INTO tbl_banks(id,name,transfers)VALUES(1,'BBVA',0);